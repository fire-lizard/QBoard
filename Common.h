...
inline GameVariant chessVariants[] = { Chess, CapablancaChess, GothicChess, JanusChess, GrandChess, OmegaChess, ChancellorChess, ModernChess };
...
inline PieceType WhaleShogiPieces[] = { King, DragonKing, GreyWhale, Porpoise, Narwhal, Humpback, BlueWhale, Pawn };
...
inline char DAIDAISHOGIFEN[] = "ly!d~rh~dp'r~kl~qu'hg~t!j'l/am'n!'c~f'x'ogb~gxzi~o!nk'a/1b1e~1a~1sq~s1w!1f~1v1/"
"j~o'g'c'w'ujcp~cjuw'b'h'n'k~/r'mv'a'wn~fo~y'o~fn~wa'v'ml'/ppppppppppppppppp/5m~5m~5/"
"17/17/17/"
"5M~5M~5/PPPPPPPPPPPPPPPPP/L'MV'A'WN~FO~Y'O~FN~WA'V'MR'/K~N'H'B'W'UJCP~CJUW'C'G'O'J~/"
"1V1F~1W!1SQ~S1A~1E~1B1/AK'NO!I~ZXGB~GOX'F'C~N!'M'A/LJ'T!G~HU'QL~KR~P'DH~RD~Y!L";
